...
if ($.isNode()) {
      dkdurlArr.push = ('"http://dkd-api.dysdk.com/user/index"')
      dkdhdArr.push = ('{"Accept-Encoding":"br;q=1.0, gzip;q=0.9, deflate;q=0.8","Accept":"*/*","Connection":"keep-alive","Content-Type":"application/x-www-form-urlencoded; charset=utf-8","Host":"dkd-api.dysdk.com","If-None-Match":"\"322cbc1006810c05415a45710d197a4de16886c5\"","User-Agent":"duokandian/3.0.2 (com.duoyou.duokandian1; build:0; iOS 14.4.0) Alamofire/5.4.0","Accept-Language":"zh-Hans;q=1.0","headerinfo":"","Content-Length":"38"}')
      dkdbodyArr.push = ('token=ddd4a7559ddf8f4670c2f98ea4a74541')
      dkdtxurlArr.push = ('dkdurl')
      dkdtxhdArr.push = ('dkdurl')
      dkdtxbodyArr.push = ('dkdurl')
